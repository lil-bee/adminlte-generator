            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="https://th.bing.com/th/id/OIP.wr7-rYIPzEaV8NQJqDvkhQAAAA?pid=ImgDet&w=400&h=416&rs=1" class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <img src="https://th.bing.com/th/id/OIP.wr7-rYIPzEaV8NQJqDvkhQAAAA?pid=ImgDet&w=400&h=416&rs=1" class="img-circle elevation-2" alt="User Image">
                            <p>
                                {{ Auth::user()->name }}
