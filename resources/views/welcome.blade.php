                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="https://infyom.com/open-source/laravelgenerator/docs/8.0/introduction" class="underline text-gray-900 dark:text-white">
                                    Documentation
                                </a>
                            </div>
                        </div>
